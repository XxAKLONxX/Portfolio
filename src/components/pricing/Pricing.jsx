  ...
  <section className="pricing container section">
    ...
    <div className="pricing__container grid">
      <div className="pricing__item">
        ...
        <p className="pricing__title">A simple Plan</p>
      ...
      <div className="pricing__item best">
        ...
        <p className="pricing__title">Quality services</p>
      ...
      <div className="pricing__item ">
        ...
        <h3 className="pricing__plan">Business</h3>
        <p className="pricing__title">At your disposal</p>
